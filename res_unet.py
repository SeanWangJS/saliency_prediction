...
class ResUNet(torch.nn.Module):
    def __init__(self):
        ...
        self.down1 = self._make_layer(64, 64)
        self.down2 = self._make_layer(64, 128, 2)
        self.down3 = self._make_layer(128, 256, 2)
        self.down4 = self._make_layer(256, 512, 2)
        self.down5 = self._make_layer(512, 1024, 2)

        self.up1 = DeConv(1024, 512)
        self.conv1 = self._make_layer(1024, 512)
        self.up2 = DeConv(512, 256)
        self.conv2 = self._make_layer(512, 256)
        self.up3 = DeConv(256, 128)
        self.conv3 = self._make_layer(256, 128)
