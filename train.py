...
def arg_parse():
    ...
    parser.add_argument("--batch_size", dest="batch_size", default=4, help="Batch size for training")
...
if __name__ == '__main__':
    ...
    trainset=SaliconDataset(data_dir, "train", (600, 448))
    valset = SaliconDataset(data_dir, "val", (600, 448))
    ...
    for epoch in range(start_epoch, start_epoch + nEpochs, 1):
        ...
        torch.save(model.state_dict(), f"{checkpoints_dir}/salicon-{epoch}.pth")